			...
			<div class="col-lg-10 col-lg-offset-1 text-center">
				...
				<form action="/" method="POST">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="email" class="form-control form-control-lg" name="inputEmail3" id="inputEmail3"
					...
					<div class="form-group row">
						<div class="col-sm-offset-2 col-sm-10">
							<button type="submit" class="pull-left btn btn-large btn-primary text-uppercase"><i
									class="fa fa-envelope-o fa-fw"></i> Send Message
							</button>
						</div>
					</div>
				</form>
